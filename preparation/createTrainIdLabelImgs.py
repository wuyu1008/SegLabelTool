...
def main():
    ...
    for f in files:
        ...
        dst = f.replace( "_polygons.json" , "_labelIds.png" ) #"_labelTrainIds.png"  "_labelIds.png" "_color.png"
        #dst = f.replace("_polygons.json", "_color.png")  # "_labelTrainIds.png"  "_labelIds.png" "_color.png"
        # do the conversion
        try:
            json2labelImg( f , dst , "ids" ) #"trainIds"  "ids"  "color"
            #json2labelImg(f, dst, "color")  # "trainIds"  "ids"  "color"
        except:
